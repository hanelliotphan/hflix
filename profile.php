    ...
    try {
        ...
        if($result) {
            $subscriptionMessage = "<div class='alertSuccess'>
                            You are now subscribed to HFlix Premium!
                        </div>";
        }
...
<div class="settingsContainer column">
    ...
    <div class="formSection">
        ...
        if($user->getIsSubscribed()) {
            echo "<h3>Current Plan: HFlix Premium</h3>";
            echo "<h3>Please go to PayPal to cancel your subscription</h3>";
        }
        else {
            echo "<a href='billing.php'>Subscribe to HFlix</a>";
        }
        ?>
    </div>
</div>
